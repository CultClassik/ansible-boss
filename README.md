# py-ansible-control [![Build Status](https://travis-ci.org/CultClassik/py-ansible-control.svg?branch=master)](https://travis-ci.org/CultClassik/py-ansible-control)
